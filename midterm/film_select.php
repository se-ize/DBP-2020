<?php
    ...
    $query = "
        ...
        special_features, language_id, rental_duration, rental_rate
        from film 
        inner join film_category 
        on film.film_id = film_category.film_id
        inner join category 
        on film_category.category_id = category.category_id 
        where film.film_id between {$filtered['num']} and {$filtered['num']}+{$filtered['strength']}-1
        ORDER BY 1 desc";
...
<body>
    <h2><a href="index.php">매장 재고 영화 시스템</a> | 영화 정보</h2>
    <table>
        <tr>
            <th>film_id</th>
            <th>title</th>
